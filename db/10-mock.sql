...
INSERT INTO challenges (uuid, day_id, title, tags, open_at, created_by)
VALUES
    ('cb9dcd1f-d2c4-40ed-a255-c240178ce789', 1, 'Day 1', ARRAY['math'], '2024-12-01 07:00:00', 'david'),
    ('3d73c233-2c0e-44f1-861f-d1b3c5a2b9f1', 2, 'Day 2', ARRAY['statistics', 'math'], '2024-12-02 07:00:00', 'frank'),
    ('34dd7273-166d-403c-8ac5-747234e51a1a', 3, 'Day 3', ARRAY['viz'], '2024-12-03 07:00:00', 'grace'),
    ('4cc6368d-004f-4fbf-88e7-1e5d0314c1d6', 4, 'Day 4', ARRAY['python'], '2024-12-04 07:00:00', 'frank'),
    ('f2055f10-92c8-4c93-a064-c133ce450b24', 5, 'Day 5', ARRAY['math'], '2024-12-05 07:00:00', 'bob'),
    ('e1423bb7-4dbb-4e54-a3e8-448731d4e5b5', 6, 'Day 6', ARRAY['math'], '2024-12-06 07:00:00', 'frank'),
    ('a8e2e1d3-642a-4ab4-8e32-0b8b7a7765c1', 7, 'Day 7', ARRAY['R', 'python'], '2024-12-07 07:00:00', 'grace'),
    ('6edec036-ee9a-4db7-8f08-2e53420a3d6a', 8, 'Day 8', ARRAY['excel'], '2024-12-08 07:00:00', 'frank'),
    ('f453a4f3-cdea-4f6a-9e2d-2c6cc188a7d5', 9, 'Day 9', ARRAY['python'], '2024-12-09 07:00:00', 'grace'),
    ('d99e24e8-d41c-4bd2-8320-d489b9005f07', 10, 'Day 10', ARRAY['sql'], '2024-12-10 07:00:00', 'frank'),
    ('8a3f62bf-02c9-4e34-8f23-bf1d03f8a77d', 11, 'Day 11', ARRAY['math'], '2024-12-11 07:00:00', 'grace'),
    ('7543f8cc-88fb-4f23-9469-e5016873d79a', 12, 'Day 12', ARRAY['python'], '2024-12-12 07:00:00', 'frank'),
    ('3d2d9d19-e0a8-40cf-b87d-d647b95a7819', 13, 'Day 13', ARRAY['math'], '2024-12-13 07:00:00', 'grace'),
    ('2e4a7b39-072c-428a-813c-ee7173f0c4d3', 14, 'Day 14', ARRAY['ethics'], '2024-12-14 07:00:00', 'frank'),
    ('3a4bfbc8-e747-431f-b2c6-70df05b5c6c5', 15, 'Day 15', ARRAY['excel'], '2024-12-15 07:00:00', 'grace'),
    ('394cf17e-b0b2-4e0f-a376-ea0f8472ff45', 16, 'Day 16', ARRAY['R'], '2024-12-16 07:00:00', 'charlie'),
    ('8a66350a-1159-493a-a72e-1c0c3f1e8a2d', 17, 'Day 17', ARRAY['python', 'R', 'statistics'], '2024-12-17 07:00:00', 'grace'),
    ('7f3f7db4-d43c-429d-9bb1-dc88be55c7f7', 18, 'Day 18', ARRAY['sql'], '2024-12-18 07:00:00', 'frank'),
    ('c85d7d2b-4f7c-42e1-9f5f-01cb94da2d04', 19, 'Day 19', ARRAY['statistics', 'math'], '2024-12-19 07:00:00', 'grace'),
    ('9ccf5ba9-98b6-4e64-944f-b38efc38b425', 20, 'Day 20', ARRAY['math'], '2024-12-20 07:00:00', 'frank'),
    ('9d58b007-565b-43c6-bb9c-7d4f2faa63a4', 21, 'Day 21', ARRAY['python'], '2024-12-21 07:00:00', 'bob'),
    ('03d2a36b-11ef-4d32-9df4-ffde6a9e63fb', 22, 'Day 22', ARRAY['python', 'R'], '2024-12-22 07:00:00', 'frank'),
    ('d54d18d8-b6af-447d-9af4-4c4bf0ec2073', 23, 'Day 23', ARRAY['python', 'math'], '2024-12-23 07:00:00', 'jane.smith'),
    ('c2b54d1a-8e5d-47ef-97f8-731d31e09a4c', 24, 'Day 24', ARRAY['X-mas Special!'], '2024-12-24 07:00:00', 'frank');
